...
import se.bupp.cs3k.lobby.ui.TeamLobbyPanel;
 ...
 */
public class NonTeamLobbyHandler extends AbstractLobbyServerHandler {


    Integer gameSize = null;


    public NonTeamLobbyHandler(LobbyClient lobbyClient) {
        super(lobbyClient);
    }
