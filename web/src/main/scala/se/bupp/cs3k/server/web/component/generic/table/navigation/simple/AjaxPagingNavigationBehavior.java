...
import se.bupp.cs3k.server.web.component.generic.table.navigation.simple.AjaxPagingNavigatorSimple;
...
public class AjaxPagingNavigationBehavior extends AjaxEventBehavior
{
    ...
    protected void onEvent(AjaxRequestTarget target)
    {
        ...
        AjaxPagingNavigatorSimple navigator = ((Component)owner).findParent(AjaxPagingNavigatorSimple.class);
